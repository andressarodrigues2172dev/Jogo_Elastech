...
public class Jogo {
    ...
    public void historia() {
        System.out.println("\n\nEm  um reino distante, o Professor Mal planeja subjugar os alunos para seus propósitos malignos. Sofia, Lina e Elena, alunas talentosas, descobrem seus planos");
        tempo(2700);
